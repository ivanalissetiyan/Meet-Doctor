                                            ...
                                            <form class="form form-horizontal" action="{{ route('backsite.role.store') }}"
                                                ...
                                                <div class="form-actions text-right">
                                                    <button type="submit" style="width:120px;" class="btn btn-cyan"
                                                        onclick="return confirm('Apakah anda yakin ingin simpan data ?')">
                                    ...
                                    <div class="card-content collapse show">
                                        <div class="card-body card-dashboard">
                                            ...
                                            <div class="table-responsive">
                                                <table {{-- tambahin text-inputs-searching kalau mau ada search nya di bawah --}}
                                                    class="table table-striped table-bordered default-table">
                                                    <thead>
                                                        <tr>
                                                            <th>Date</th>
                                                            <th>Role</th>
