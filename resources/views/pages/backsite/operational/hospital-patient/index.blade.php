                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Hospital Patient</h4>
                                    ...
                                    <div class="card-content collapse show">
                                        <div class="card-body card-dashboard">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered default-table">
                                                    <thead>
                                                        <tr>
                                                            <th>Date</th>
                                                            <th>Nama Patient</th>
                                                    ...
                                                    <tbody>
                                                        @forelse($hospital_patient as $key => $hospital_patient_item)
                                                            <tr data-entry-id="{{ $hospital_patient_item->id }}">
                                                                ...
                                                                <td>{{ $hospital_patient_item->users->name ?? '' }}</td>
                                                                <td>{{ $hospital_patient_item->type_user->name ?? '' }}</td>
                                                                <td>{{ $hospital_patient_item->contact ?? '' }}
                                                                <td>{{ $hospital_patient_item->address ?? '' }}
                                                                <td>{{ $hospital_patient_item->photo ?? '' }}
                                                                <td>{{ $hospital_patient_item->gender ?? '' }}
                                                                </td>
